...
import { z } from 'zod';
import { METADATA_LABEL_VALID_PATTERN, METADATA_LABEL_VALID_UNS } from '~/pages/settings/data-model/constants/MetadataLabelValidPattern';
...
export const metadataLabelSchema = (existingLabels?: string[]) => {
  return z
    ...
    .regex(METADATA_LABEL_VALID_UNS,errors.LabelUnSportedspecialCharacters)
